    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div style="margin-bottom: 10px;">
                        <button type="button" class="modal-effect btn btn-success" data-effect="effect-scale"
                            ...
                            <i class="ti-plus"></i> {{trans('admin.add_city')}}
                        </button>
                    </div>
                    <hr>
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered p-0">
                            ...
                            @foreach($cities as $city)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-danger" data-effect="effect-scale"
                                           data-toggle="modal" href="#delete{{ $city->id }}" title="حذف">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="exampleModalLabel">{{trans('admin.edit_city')}}</h5>
                                ...
                                <!-- Delete -->
                                <div class="modal fade" id="delete{{ $city->id }}">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                                <h6 class="modal-title">{{trans('admin.delete_city')}}</h6>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">{{trans('admin.add_city')}}</h6>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('cities.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="exampleInputEmail1">{{trans('admin.city_name')}}</label>
